...
class PlayerBottomSheet : FrameLayout, PlayerBottomSheetType {
  ...
  private var openListener: PlayerBottomSheetType.SheetOpenListenerType =
    this.ignoreOpenListener

  private val logger =
    LoggerFactory.getLogger(PlayerBottomSheet::class.java)
  ...
  private class SwipeGestureListener(
    private val parent: PlayerBottomSheet
  ...
  override fun addView(
    ...
    if (child.id == R.id.playerBottomSheet) {
      super.addView(child, index, params)
      this.contentArea =
        child.findViewById(R.id.playerBottomSheetContent)
      this.handle =
        child.findViewById(R.id.playerBottomSheetHandle)
  ...
  override fun drawerOpen() {
    ...
    this.isOpen = true
    this.updateHandleAccessibilityStrings()
    this.importantForAccessibility = IMPORTANT_FOR_ACCESSIBILITY_AUTO
  ...
  override fun drawerClose() {
    ...
    this.isOpen = false
    this.updateHandleAccessibilityStrings()
    this.importantForAccessibility = IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS
  ...
  private class IgnoreOpenListener : PlayerBottomSheetType.SheetOpenListenerType {
